...
public class LongEffectAction implements ModAction, ActionPerformer, BehaviourProvider {
    private final short actionId = (short) ModActions.getNextActionId();
    private final ActionEntry actionEntry;

    public LongEffectAction() {
        this.actionEntry = ActionEntry.createEntry(this.actionId, "Long status effect", "longing",
                new int[]{
    ...
    private boolean doTheThing(Creature performer) {
        ...
        StatusEffectClass.sendStatusEffect(performer, 120);
        return true;
    }
}
